...
The demo project represents one of the possible logics for the login system, inventory, and in-game store based on Xsolla products ([Login](https://developers.xsolla.com/authenticate-users/), [In-Game Store](https://developers.xsolla.com/virtual-goods/own-ui/), and [Pay Station](https://developers.xsolla.com/payment-ui-and-flow/)).
...
**NOTE:** By default, the demo is working in sandbox mode. To test the purchase process, use [test cards](https://developers.xsolla.com/dev-resources/testing/test-cards/). Sandbox mode only simulates the behavior of a payment method, no real money is involved. You can try out sandbox mode without signing any agreements with Xsolla or paying any fees.
...
* [Developer documentation](https://developers.xsolla.com/sdk/unity-enterprise/)
