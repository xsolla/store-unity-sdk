...
namespace Xsolla.Auth
{
	...
	{
		public IWidgetAuthenticator Create(Action onSuccess, Action<Error> onError, Action onCancel, string locale)
		{
#if UNITY_STANDALONE || UNITY_EDITOR
			return new StandaloneWidgetAuthenticator(onSuccess, onError, onCancel, locale);
#elif UNITY_ANDROID
